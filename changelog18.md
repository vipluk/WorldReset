...
* ⏳ **Smart Limbo Reconnect Handling:** Players reconnecting while in Limbo during an active game are automatically restored to the world unless `new-players-to-limbo: true` is enabled.
